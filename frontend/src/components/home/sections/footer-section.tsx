...
export function FooterSection() {
  ...
  const logoSrc = !mounted ? "/CloudOne-logo.svg" : 
    (resolvedTheme === "dark" ? "/CloudOne-logo-white.svg" : "/CloudOne-logo.svg");
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between p-10 max-w-6xl mx-auto">
        <div className="flex flex-col items-start justify-start gap-y-5 max-w-xs mx-0">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/cloudone-ai/helios" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            ...
            <a href="https://x.com/CloudOneai" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="size-5 text-muted-foreground hover:text-primary transition-colors">
