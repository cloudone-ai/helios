  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl mx-auto px-6">
        <SectionHeader>
          <h2 className="text-3xl md:text-4xl font-medium tracking-tighter text-center text-balance pb-1">{t('openSource.title')}
            
          </h2>
          <p className="text-muted-foreground text-center text-balance font-medium">{t('openSource.desc')}
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="relative">
                <h3 className="text-2xl font-semibold tracking-tight">
                  {t('openSource.generalist')}
                </h3>
                <p className="text-muted-foreground mt-2">
                  {t('openSource.explore')}
                </p>
              </div>
              ...
              <Link 
                href="https://github.com/cloudone-ai/helios" 
                target="_blank" 
          ...
          <div className="rounded-xl bg-[#F3F4F6] dark:bg-[#F9FAFB]/[0.02] border border-border p-6">
            <div className="flex flex-col gap-6">
              <h3 className="text-xl md:text-2xl font-medium tracking-tight">
                {t('openSource.transparencyTrust')}
              </h3>
              <p className="text-muted-foreground">
                {t('openSource.trustDesc')}
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">{t('openSource.transparencyDesc')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="rounded-full bg-secondary/10 p-2 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">{t('openSource.communityDesc')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="rounded-full bg-secondary/10 p-2 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">{t('openSource.licenseDesc')}</p>
                  </div>
                </div>
              </div>
            </div>
