                ...
                {activeTab === "terms" ? (
                  <div>
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      ...
                      <li>"Notice Address" refers to the contact address for the Company, specifically legal@cloud1soft.com</li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">The Company utilizes artificial intelligence systems to generate content and perform actions. Such generation may unintentionally involve copyrighted material or trademarks held by others. We respect rights holders internationally, and we ask our users to do the same. If you believe your copyright or trademark is being infringed by the Service, please write to legal@cloud1soft.com and we will process and investigate your request and take appropriate actions under the Digital Millennium Copyright Act and other applicable intellectual property laws with respect to any alleged or actual infringement.</p>

                    <h3 className="text-lg font-medium tracking-tight">Fees and Payments</h3>
                    <p className="text-muted-foreground text-balance mb-4">The Company may offer paid Services. You can learn more about our pricing after signing up. You may sign up for a subscription, payable in U.S. dollars, that will automatically renew. You can stop using the Service and cancel your subscription at any time through the website or by emailing us at legal@cloud1soft.com. If you cancel your subscription, you may not receive a refund or credit for any amounts that have already been billed or paid. The Company reserves the right to change its prices at any time. If you are on a subscription plan, changes to pricing will not apply until your next renewal.</p>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">For questions regarding the Service, you can get in touch by emailing us at <a href="mailto:legal@cloud1soft.com" className="text-secondary hover:underline">legal@cloud1soft.com</a>.</p>
                  </div>
                ) : (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">References to our "Services" at Helios in this statement include our website, apps, and other products and services. This statement applies to our Services that display or reference this Privacy Statement. Third-party services that we integrate with are governed under their own privacy policies.</p>

                    <p className="text-muted-foreground text-balance mb-6">Helios does not collect biometric or identifying information. All data is processed securely and any data is deleted upon account removal.</p>
                    ...
                    <h3 className="text-lg font-medium tracking-tight">Contact Us</h3>
                    <p className="text-muted-foreground text-balance">You can get in touch by emailing us at <a href="mailto:legal@cloud1soft.com" className="text-secondary hover:underline">legal@cloud1soft.com</a>.</p>
                  </div>
                )}
              </div>
            </div>
