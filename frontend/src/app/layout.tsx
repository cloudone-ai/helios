...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Helios - Open Source Generalist AI Agent",
    description: "Helios is a fully open source AI assistant that helps you accomplish real-world tasks with ease through natural conversation.",
    url: siteConfig.url,
    siteName: "Helios",
    images: [{
      url: "/banner.png",
      width: 1200,
      height: 630,
      alt: "Helios - Open Source Generalist AI Agent",
      type: "image/png",
    }],
    locale: "en_US",
    type: "website",
